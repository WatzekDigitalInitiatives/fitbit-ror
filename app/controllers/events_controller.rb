                ...
                if @event.team_event
                    ...
                    if @team_event.save
                        ...
                        @team.users.each do |user|
                            ...
                            create_user_subscription(user) if current_user.events.count == 1 && Rails.env.production?
                        end
                    ...
                    if @user_event.save
                        ...
                        create_user_subscription(current_user) if user.events.count == 1 && Rails.env.production?
                        format.html { redirect_to @event, notice: 'Event was successfully created.' }
                        format.json { render :show, status: :created, location: @event }
                    end
                end
