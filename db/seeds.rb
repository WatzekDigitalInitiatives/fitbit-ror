...
event1 = Event.create(name: 'Test Event 1', start_date: '2016-10-15', finish_date: '2016-10-28', start_location: 'Portland, OR',
            end_location: 'Seattle, WA', createdby: 1, invitecode: 'M1BFVZ', private: false, team_event: false)
...
UserEvent.create(user_id: 1, event_id: event2.id)
UserEvent.create(user_id: 1, event_id: event6.id)
UserEvent.create(user_id: 2, event_id: event2.id)
UserEvent.create(user_id: 2, event_id: event5.id)
UserEvent.create(user_id: 2, event_id: event1.id)
